...
User Function RA_PERCAPD()
	...
	@ 016, 020 GET _TribMerInt   Picture "99.99"  SIZE 040, 11
	
	@ 036, 020 Say "% Não tributados no Mercado Interno"
	@ 046, 020 GET _NaoTribMerInt  Picture "99.99"  SIZE 040, 11
	
	@ 066, 020 Say "% Exportação"
	@ 076, 020 GET _Exportacao  Picture "99.99"  SIZE 040, 11
