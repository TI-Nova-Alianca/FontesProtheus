...
user function AtuEstru (_sAlias, _sCondApp)
	...
	u_logIni ()
	u_log ('Tentando atualizar estrutura da tabela', _sAlias)
	if _lContinua
...
//			_nRegOri = (_sAlias) -> (reccount ())
	...
	if _lContinua
		...
		(_sAlias) -> (dbclosearea ())
		dbselectarea ("SM0")
		u_logDH ('Criando backup no SQL (', _nRegOri, 'registros)')
