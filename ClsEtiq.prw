...
CLASS ClsEtiq
	...
	data Apontada      // ZA1_APONT - Apontamento de producao ja executado (quando etiq. para OP)
	data Codigo        // ZA1_CODIGO
	data DocEntrForn   // ZA1_FORNEC - Quando refere-se a NF de entrada
	data DocEntrItem   // ZA1_ITEM - Quando refere-se a NF de entrada
	data DocEntrLoja   // ZA1_LOJAF - Quando refere-se a NF de entrada
	data DocEntrNum    // ZA1_DOCE - Quando refere-se a NF de entrada
	data DocEntrSerie  // ZA1_SERIEE - Quando refere-se a NF de entrada
	data DtEmis        // ZA1_DATA
	data Filial        // ZA1_FILIAL
	data IdZAG         // ZA1_IDZAG - Identificador de registro da tabela ZAG
	data Impressa      // ZA1_IMPRES - Jah impressa
	data LoteProduto
	data OP            // ZA1_OP
	data Produto       // ZA1_PROD
	data QtApontada    // Quando relacionada a uma OP
	data QtEstornada   // Quando relacionada a uma OP
	data QtPerdida     // Quando relacionada a uma OP
	data Quantidade    // ZA1_QUANT
	data SeqNoGrupo    // ZA1_SEQ - Sequencia dentro do grupo, geralmente de OP. Ex.: 1 de 10, 2 de 10, ...
	data UsrIncl       // ZA1_USRINC - Usuario que incluiu/gerou a etiqueta
	data ValidadeLote
