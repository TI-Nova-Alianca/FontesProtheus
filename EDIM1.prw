...
// 21/02/2011 - Robert  - Criado tratamento para quando der erro em rotina automatica, 
//                        mas nao houver arquivo de log gerado.
...
// 01/03/2012 - Robert  - Disponibilizacao da variavel private _sErroEDI para retorno de msg por 
//                        pontos de entrada posteriores.
...
// 21/05/2013 - Robert  - Tratamento da variavel _sErroEDI desabilitado, passa a usar _sErroAuto, 
//                        que jah tem tratamento na funcao U_Help.
...
// 18/11/2015 - Robert  - Produtos inativos e bloqueados passam a ser desconsiderados na busca de 
//                        codigos a partir do cod.barras.
// 01/03/2017 - Robert  - Chamada da funcao ConfirmSXC8() apos o MATA410 para tentar eliminar 
//                        perda se sequencia de numero de pedidos.
// 14/09/2017 - Robert  - Removido indice 1 (por recno()) dos arquivos de trabalho, 
//                        pois era desnecessario e dava erro na funcao U_ArqTrb().
...
// 10/11/2020 - Robert  - Passa a alimentar o campo C6_VAPOER para gerar TES via gatilhos 
//                        do TES inteligente (GLPI 8785).
// 11/08/2021 - Claudia - Validação de nome do cliente, conforme GLPI: 10710
// 01/09/2021 - Robert  - Criado tratamento para campo C5_INDPRES: sempre 5=venda com entrega 
//                        fora do estabelecimento (GLPI 10085)
...
Static Function _GeraPed(_sSeqPed)
	...
	if _lContinua
		...
		aadd(_aAutoSC5, {"C5_INDPRES"	, '1'														, NIL})  // (GLPI 10085)
	...
	do while _lContinua .and. ! _itens -> (eof()) .and. _itens -> SeqPed == _sSeqPed
		...
		if _lContinua
			...
			if _itens -> PrUnitLiq > 0 // Produtos sem valor ficam bloqueados.
