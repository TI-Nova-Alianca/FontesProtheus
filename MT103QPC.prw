...
User Function MT103QPC    
    ...
    Else        // Montar a Query ao pressionar F6
        cQryRet := ""
        cQryRet += " SELECT
        cQryRet += " 	 C7_FILIAL,C7_TIPO,C7_ITEM,C7_PRODUTO,C7_EMAIL,C7_DESCRI,C7_UM,C7_SEGUM,C7_QUANT,C7_CODTAB,C7_PRECO "
        cQryRet += " 	,C7_TOTAL,C7_CONTA,C7_DATPRF,C7_CC,C7_ITEMCTA,C7_QTSEGUM,C7_IPI,C7_NUMSC,C7_ITEMSC,C7_LOCAL,C7_COND "
        ...
        cQryRet += " 	,C7_LOJFABR,C7_DT_EMB,C7_TEC,C7_EX_NCM,C7_EX_NBM,C7_DIACTB,C7_NODIA,C7_VAOBRA,C7_VAPROSE,C7_VAZZG "
        cQryRet += " 	,C7_VAZZGC,C7_VAZZG2,C7_VAFCOBR,C7_VAMTINV,C7_ESTOQUE,C7_CODED,C7_PO_EIC,C7_NUMPR,C7_RATEIO,C7_FILCEN "
    ...
    nHandle := FCreate("c:\temp\mt103qpc.txt")
    FWrite(nHandle,cQryRet )
    FClose(nHandle)
