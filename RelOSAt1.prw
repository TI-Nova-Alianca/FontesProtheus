...
_oSQL:_sQuery += "     ,SUBSTRING(STJ.TJ_DTMPINI, 7, 2) + '/' + SUBSTRING(STJ.TJ_DTMPINI, 5, 2) + '/' + SUBSTRING(STJ.TJ_DTMPINI, 1, 4) AS DATA_INI "
_oSQL:_sQuery += "     ,STJ.TJ_HOMPINI AS HORA_INI
_oSQL:_sQuery += "     ,SUBSTRING(STJ.TJ_DTMPFIM, 7, 2) + '/' + SUBSTRING(STJ.TJ_DTMPFIM, 5, 2) + '/' + SUBSTRING(STJ.TJ_DTMPFIM, 1, 4) AS DATA_FIM "
_oSQL:_sQuery += "     ,STJ.TJ_HOMPFIM AS HORA_FIM "
