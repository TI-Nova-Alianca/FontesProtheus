...
// 25/02/2024 - Robert  - Novos parametro para selecionar E2_PARCELA (GLPI 14961) 
//                        e observacoes para log de eventos.
//                      - Migrado da funcao processa() para MsNewProcess() que me 
//                        permitiu habilitar o botao de cancelamento.
//                     -  Passa a ter controle de semaforo para acesso exclusivo.
// 08/07/2024 - Claudia - Incluido filtro de TIPO de titulo. GLPI: 15660
//
// ---------------------------------------------------------------------------------------------------
...
static function _Gera(_oProcess, _lCancProc)
	...
	if ! empty(mv_par13)
		_oSQL:_sQuery +=    " AND SE2.E2_TIPO = '" + mv_par13 + "'"
	endif
	if ! empty(mv_par09)
...
Static Function _ValidPerg ()
	...
	aadd(_aRegsPerg, {13, "Tipo do título(vazio=todas)   ", "C", 3,                        0,  "",   "05    ", {},    ""})
