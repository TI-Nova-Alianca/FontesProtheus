...
// Descricao.: Processa chamada do calculo da ST 
//             unificar rotinas (chamadas do VA_GAT -pedido e lista e chamada do VA_RSTTP)
//
// Tags para automatizar catalogo de customizacoes:
// #TipoDePrograma    #processo
// #Descricao         #Processa chamada do calculo da ST
// #PalavasChave      #calculo_st 
// #TabelasPrincipais #SA1 #DA1 #SB1
// #Modulos           #FIS #EST
//                                                                                                                                                     
// Historico de alteracoes:
// 10/12/2013 - Robert  - Novo parametro (simples nacional) na funcao CALCST3.
// 25/06/2014 - Catia   - Recalculo e Gatilho da ST - alterada prioridade da UF. 
//                        Usa DA1_ESTADO e depois DA0_UF
...
user function VA_PROCST(_pQual, _pCliente, _pLoja, _pTpPed, _pProd, _pTes, _pCFOP, _pQte, _pPreco, _pValor, _pVlrIPI, _pUF, _pPercICM, _pCodTab, _pItem, _sSimples)
   ...
   if _pQual == 'P'  // Pedido de Venda
      ...
      if ! _pTpPed $ "BD" .and. ((alltrim(upper(_sIE)) != "ISENTO" .or. alltrim(_sIE) != "") .or. _sMEI == 'S') .and. cEmpAnt != "02"  // Na Vinicola nao deve calcular.
