...
/* ===============================================================================
WSDL Location    https://portalnfe.walmart.com.br/Gnfe_Port_ws/cls_403_nfe_xml.asmx?WSDL
Gerado em        11/06/12 11:26:04
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

//User Function _TTNOGBV ; Return  // "dummy" function - Internal Use 

/* -------------------------------------------------------------------------------
WSDL Service WScls_sud_nfe_xml
------------------------------------------------------------------------------- */

WSCLIENT WScls_sud_nfe_xml
	...
	WSDATA   oWSfu_upldResult          AS cls_sud_nfe_xml_SqlExecutionRetn

ENDWSCLIENT

WSMETHOD NEW WSCLIENT WScls_sud_nfe_xml
::Init()
...
WSMETHOD INIT WSCLIENT WScls_sud_nfe_xml
	::oWSfu_upldResult   := cls_sud_nfe_xml_SQLEXECUTIONRETN():New()
Return

WSMETHOD RESET WSCLIENT WScls_sud_nfe_xml
	::cpa_tp_cd_usua     := NIL 
	::npa_cd_usua        := NIL 
	::cpa_ds_xml_nfe     := NIL 
...
WSMETHOD CLONE WSCLIENT WScls_sud_nfe_xml
Local oClone := WScls_sud_nfe_xml():New()
	oClone:_URL          := ::_URL 
	oClone:_CERT         := ::_CERT 
...
// WSDL Method fu_upld of Service WScls_sud_nfe_xml

WSMETHOD fu_upld WSSEND cpa_tp_cd_usua,npa_cd_usua,cpa_ds_xml_nfe WSRECEIVE oWSfu_upldResult WSCLIENT WScls_sud_nfe_xml
Local cSoap := "" , oXmlRet
...
oXmlRet := SvcSoapCall(	Self,cSoap,; 
	...
	"https://portalnfe.walmart.com.br/Gnfe_Port_ws/cls_403_nfe_xml.asmx")
...
WSSTRUCT cls_sud_nfe_xml_SqlExecutionRetn
...
WSMETHOD NEW WSCLIENT cls_sud_nfe_xml_SqlExecutionRetn
	::Init()
Return Self

WSMETHOD INIT WSCLIENT cls_sud_nfe_xml_SqlExecutionRetn
Return

WSMETHOD CLONE WSCLIENT cls_sud_nfe_xml_SqlExecutionRetn
	Local oClone := cls_sud_nfe_xml_SqlExecutionRetn():NEW()
	oClone:nreturn_code         := ::nreturn_code
	oClone:creturn_chav         := ::creturn_chav
Return oClone

WSMETHOD SOAPRECV WSSEND oResponse WSCLIENT cls_sud_nfe_xml_SqlExecutionRetn
	::Init()
