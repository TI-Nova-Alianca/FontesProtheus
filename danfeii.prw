...
For nY := 1 To nLenItens
	...
	Else
		...
		nAuxH += aTamCol[1]
		If aAux[1][2][nY][2]
			oDanfe:Say(nLinha, nAuxH + 2, aAux[1][2][nY][1], oFont08N:oFont) // COD ONU DESTACADO EM NEGRITO
		else
			oDanfe:Say(nLinha, nAuxH + 2, aAux[1][2][nY][1], oFont08:oFont) // DESCRICAO DO PRODUTO
		EndIf
		nAuxH += aTamCol[2]
